...
# terminal command :  python inference_gfpgan.py -i inputs/whole_imgs -o results -v 1.4 -s 4 --bg_upsampler realesrgan
...
def main():
    ...
    parser.add_argument('-w', '--weight', type=float,
                        default=0.5, help='Adjustable weights.')
    ...
    for img_path in img_list:
        ...
        for idx, (cropped_face, restored_face) in enumerate(zip(cropped_faces, restored_faces)):
            ...
            imwrite(cmp_img, os.path.join(args.output,
                    'cmp', f'{basename}_{idx:02d}.png'))
